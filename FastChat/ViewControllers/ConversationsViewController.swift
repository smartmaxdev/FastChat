...
class ConversationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    lazy var leftButton: UIBarButtonItem = {
        ...
        let button  = UIBarButtonItem.init(image: image, style: .plain, target: self, action: #selector(ConversationsViewController.showProfile))
        return button
    }()
    ...
    func customization()  {
        ...
        let rightButton = UIBarButtonItem.init(image: icon!, style: .plain, target: self, action: #selector(ConversationsViewController.showContacts))
